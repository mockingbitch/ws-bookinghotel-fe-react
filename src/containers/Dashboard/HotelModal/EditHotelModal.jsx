...
class EditHotelModal extends Component {
  constructor(props) {
    super(props);
    this.state = {
      cities: [],
  ...
  render() {
    ...
    return (
      <Modal
        ...
        size="l"
      >
        <ModalHeader toggle={() => this.toggle()}>Update Hotel</ModalHeader>
        <ModalBody>
...
export default connect(mapStateToProps, mapDispatchToProps)(EditHotelModal);
