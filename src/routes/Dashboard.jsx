...
class Dashboard extends Component {
  ...
  render() {
    ...
    const url = 'https://github.com/mockingbitch';
      ...
      <>
        ...
        >
          <div className="sidenav-header">
            ...
            <Link
              to="/dashboard"
              onClick={() => this.handleBreadcrumb("Dashboard")}
          ...
          >
            <ul className="navbar-nav">
              ...
              <li className="nav-item">
                <NavLink
                  to="/dashboard/hotels"
                  onClick={() => this.handleBreadcrumb("Hotels")}
                  activeClassName="active"
                  className="nav-link "
                >
                  <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <li className="nav-item">
                <NavLink
                  to="/dashboard/rooms"
                  onClick={() => this.handleBreadcrumb("Rooms")}
                  activeClassName="active"
                  className="nav-link"
                >
                  <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            >
              ...
              <div className="card-body text-start p-3 w-100">
                ...
                <div className="docs-info">
                  ...
                  <a href={url} className="btn btn-white btn-sm w-100 mb-0">
                    Documentation
                  </a>
                </div>
              </div>
            </div>
            <a href={url} className="btn bg-gradient-primary mt-3 w-100">Source code</a>
          </div>
        </aside>
                        ...
                        <a className="dropdown-item border-radius-md">
                          <div className="d-flex py-1">
                            <div className="my-auto">
                              <img src="" className="avatar avatar-sm me-3" />
                            </div>
                ...
                <div className="row align-items-center justify-content-lg-between">
                  <div className="col-lg-6 mb-lg-0 mb-4">
                    <div className="copyright text-center text-sm text-muted text-lg-start">
                      ...
                      <a className="font-weight-bold" target="">
                        Team 8:
                      </a>
                      Booking Hotel.
                    </div>
          ...
          <div className="card shadow-lg">
            <div className="card-header pb-0 pt-3">
              <div className="float-start">
                <h5 className="mt-3 mb-0">Booking Hotel Configurator</h5>
            ...
            <div className="card-body pt-sm-3 pt-0">
              ...
              <Link to={url} className="btn bg-gradient-dark w-100">Source code</Link>
              <a href={url} className="btn btn-outline-dark w-100">View documentation</a>
              <div className="w-100 text-center">
                ...
                <h6 className="mt-3">Thank you for using!</h6>
                <a className="btn btn-dark mb-0 me-2" target="">
