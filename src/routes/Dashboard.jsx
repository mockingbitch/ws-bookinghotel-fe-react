            ...
            <ul className="navbar-nav">
              ...
              <li className="nav-item">
                <a className="nav-link">
                  ...
                  <span className="nav-link-text ms-1">Room Services</span>
                </a>
              </li>
            ...
            >
              ...
              <div className="card-body text-start p-3 w-100">
                ...
                <div className="docs-info">
                  ...
                  <a className="btn btn-white btn-sm w-100 mb-0">
                    Documentation
                  </a>
                </div>
              </div>
            </div>
            <a className="btn bg-gradient-primary mt-3 w-100">Source code</a>
          </div>
        </aside>
